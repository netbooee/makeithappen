...
const DATA = {
  ...
  personal: {
    ...
    someday: [
      { id: "ps1", text: "Look into a pottery class", done: false, next: false, context: "@home", project: null },
      { id: "ps2", text: "Research standing desk mats", done: false, next: false, context: "@errands", project: "Home Office Refresh" },
      { id: "ps3", text: "Plan a visit to Theo in Berlin", done: false, next: false, context: "@home", project: null },
    ],
    habits: [
...
function habitHistory(seed) {
  const weeks = 18, days = 7, out = [];
  let s = seed;
...
window.DATA = DATA;
window.habitHistory = habitHistory;
